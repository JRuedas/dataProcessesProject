...
As we can see, the five variables variables spread along wide ranges: there are many outliers or highly unexpected values. The histograms below show a better insight of the shape of the distribution that the variables follow: all of them are highly skewed to the left, so they don't follow a normal distribution.
