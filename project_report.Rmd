...
This step is followed by a **predictive analysis first step**, in which we have used **temporal series** to predict the behavior of one of the features in our data, using the ETS predictive model.
