...
After this first method, the second prediction method uses two  **machine learning approaches**, KNN and linear regression, to generate and compare two prediction models for one of our data features, and chooses the best one according with the RMSE obtained. The process to generate the two models is described, and a prediction for year 2019 is ellaborated (year for which we don't have any available data), drawing some conclussions to assess our question of interest.
